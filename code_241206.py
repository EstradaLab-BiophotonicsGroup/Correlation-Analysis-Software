...
from additional_for_interface import pCF, crosspCF
...
def plot_on_ax(ax, G_log, t_log,title):
    ...
    ax.set_xlabel('xlabel', fontsize=12)  # replace with your xlabel variable
    ...
    def plot_profile():
        ...
        try:
            ...
            if selected_channel == 'Channel 1':
                ...
                profile_ax1.set_title(f'Channel 1 Profile from Pixel {start_pixel} to {end_pixel - 1}', fontsize=16)
                profile_ax1.set_xlabel('Time', fontsize=16)
                profile_ax1.set_ylabel('Intensity', fontsize=16)
                profile_ax1.tick_params(axis='both', which='major', labelsize=14)
                profile_ax1.tick_params(axis='both', which='minor', labelsize=12)
                ...
                profile_ax2.set_title(f'Channel 2 Profile from Pixel {start_pixel} to {end_pixel - 1}', fontsize=16)
                profile_ax2.set_xlabel('Time', fontsize=16)
                profile_ax2.set_ylabel('Intensity', fontsize=16)
                profile_ax2.tick_params(axis='both', which='major', labelsize=14)
                profile_ax2.tick_params(axis='both', which='minor', labelsize=12)
            ...
            if type(G_to_save)==list:
                ...
                if end_pixel > G_to_save.shape[0]:
                    ...
                    # Set labels with larger font size
                    profile_ax.set_title(f'Average Profile from Pixel {start_pixel} to {end_pixel - 1}', fontsize=16)
                    profile_ax.set_xlabel('Time', fontsize=14)
                    profile_ax.set_ylabel('Intensity', fontsize=14)
                    
                    # Increase padding and font size for ticks
                    profile_ax.tick_params(axis='both', which='major', labelsize=14)
                    profile_ax.tick_params(axis='both', which='minor', labelsize=12)
...
root.title("Correlation Analysis Software")
